...
while ($info_contact = $requete->fetch(PDO::FETCH_ASSOC)){
    ...
    $affichage.= '<div class="col-xl-12 mt-xl-5 mt-3">';
...
<nav class="navbar mt-3 effet fixed-top">
  <a class="btn navbar-brand  border-warning  rounded-circle" href="index.php"><i class="fas fa-home home"></i></a>
  <a class="btn border-warning bg-warning" href="?lien=formations">Formations</a>
